...
export default class Projects extends React.Component {
        ...
        render() {
                ...
                check out the live site here: <a style={{ color: "black" }} href='https://mybudgetbutler.net/#/'>Budget Butler,</a>
                                         <a style={{ color: "black" }} href='GitHub code: https://github.com/groupprojectalpha/foodie'> Github.</a>
                                </p>
                ...
                check out the live site here: <a style={{ color: "black" }} href='https://telfordtechnologies.com'>SportsTrack,</a>
                                          <a style={{ color: "black" }} href='https://github.com/NathanJTelford/Portfolio-Personal-Project'> Github.</a>
                                </p>
                                <div className='project_pics'>
